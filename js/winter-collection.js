...
const HIDDEN_PRODUCTS_KEY = 'hiddenProducts_winter'; // Changed key to be collection-specific
    ...
    document.querySelectorAll('.product-edit').forEach(editIcon => {
        editIcon.addEventListener('click', function(e) {
            ...
            overlay.querySelector('.save-edit-btn').addEventListener('click', function() {
                ...
                const productId = productCard.querySelector('.select-checkbox').id;
                const editedProducts = JSON.parse(localStorage.getItem('editedProducts_winter') || '{}');
                ...
                localStorage.setItem('editedProducts_winter', JSON.stringify(editedProducts));
    ...
    if (saveButton) {
        saveButton.addEventListener('click', async () => {
            ...
            try {
                ...
                // Save to localStorage with winter-specific key
